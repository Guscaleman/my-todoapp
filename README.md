...
npm install
```
Como estamos em um ambiente de teste e utilizando o Prisma, crie um .env.test de acordo com o .env.example e preencha o JWT_SECRET com uma string aleatória.
